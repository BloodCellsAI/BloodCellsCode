...
model = DeeplabV3Plus(num_classes=12)
...
image_filenames = glob.glob('C:\Bloodcells\Modele\Data\PBC_dataset_normal_DIB\PBC_dataset_normal_DIB\Learning_base/*.png')
label_filenames = glob.glob('C:\Bloodcells\Modele\Data\PBC_dataset_normal_DIB\PBC_dataset_normal_DIB\Segmented_base/*.png')
...
torch.save(model,'C:/Bloodcells/Modele/Data/PBC_dataset_normal_DIB/PBC_dataset_normal_DIB/Learn_0/pytorch3105.pth')
